...
<object data="https://github.com/Advanse-Lab/consensus-explanability/blob/main/assets/internal_perspective_approach.pdf" type="application/pdf">
    <embed src="https://github.com/Advanse-Lab/consensus-explanability/blob/main/assets/internal_perspective_approach.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="https://github.com/Advanse-Lab/consensus-explanability/blob/main/assets/internal_perspective_approach.pdf">Download PDF</a>.</p>
    </embed>
</object>
